...
プロジェクトでは、タスクそのものの難しさだけでなく、質問しづらさ、判断待ち、確認漏れ、レビュー待ち、属人化などの「見えない詰まり」によって進行が止まることがあります。
...
Stuck Map は、個人の遅れを監視するためのものではありません。
...
たとえば、`作業中` のタスクに `手助け` サインが付いている場合、そのタスクはフロー上では作業中のまま残り、サインタブでは「手助け」として拾えるようになります。
