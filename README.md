...
Stuck Map が見たいのは、誰が悪いかではなく、誰が、何によって、どこで止まっているのかです。

外から見ると「待機している」「指示待ちしている」ように見える状態でも、実際には次のような理由で止まっていることがあります。

- 必要なファイルが共有されていない
- 権限がなく、作業に入れない
- 判断や確認が返ってこない
- 特定の人にファイル・判断・説明責任が集中している
- 助けたいが、どこまで入ってよいか分からない
- 自分側では準備済みだが、相手側の行動待ちになっている

この状態は、本人の怠慢や能力不足だけで起きるものではありません。

そのため、表示するときも「Aさん待ち」のように人を直接責める形ではなく、
...
のように、できるだけ状態として扱うことを重視します。

Stuck Map は、誰かを責める地図ではなく、助け合いが成立しない理由を見つける地図であることを目指しています。
