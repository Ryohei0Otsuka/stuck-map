...
const STORAGE_KEY = "stuck-map-v10-3-flow-gantt";
const INTRO_KEY = "stuck-map-intro-v10-3-flow-gantt";
  ...
  return (
    <div className="app-shell">
      ...
      <main className="app-frame">
        ...
        <section className="hero-panel">
          <div className="hero-copy-block surface">
            ...
            <p className="hero-copy">
              フローではプロジェクトの流れを見る。サインでは、手助け・方向相談・確認・レビューを拾う。
        ...
        <section className={`board-layout ${activeTab === "flow" ? "flow-layout" : "signal-layout"}`}>
          {activeTab === "signal" && (
            ...
            <div className="board-heading">
              <div className="panel-heading">
                ...
                <p className="panel-subtext">
                  {activeTab === "flow"
                    ? "これから → 作業中 → 完了。メンバーではなく、プロジェクトの流れを横長に見ます。"
                    : "手助け・方向相談・確認・レビュー。ここだけメンバーと吹き出しで拾いやすくします。"}
                </p>
              </div>
              <div className="board-actions">
                <div className="view-tabs" role="tablist" aria-label="表示切替">
                  <button className={activeTab === "flow" ? "active" : ""} onClick={() => setActiveTab("flow")}><span>フローを見る</span><small>TODO → DOING → DONE</small></button>
                  <button className={activeTab === "signal" ? "active" : ""} onClick={() => setActiveTab("signal")}><span>サインを拾う</span><small>HELP / WAIT / CHECK / REVIEW</small></button>
                </div>
