...
const supportActionMeta = {
  HELP: {
    label: "助かった！",
    message: "HELPサインだけを外します。タスクは完了せず、状態はそのままです。",
  },
  WAIT: {
    label: "認識OK",
    message: "認識合わせサインだけを外します。タスクは完了せず、状態はそのままです。",
  },
  CHECK: {
    label: "確認OK",
    message: "確認依頼サインだけを外します。タスクは完了せず、状態はそのままです。",
  },
  REVIEW: {
    label: "レビューOK",
    message: "レビュー依頼サインだけを外します。タスクは完了せず、状態はそのままです。",
  },
};
